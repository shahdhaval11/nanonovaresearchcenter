          ...
          {POPULAR_PROGRAMS.map((program, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  href={program.href}
                  className="group/btn mt-5 flex w-full items-center justify-center gap-1.5 rounded-md border border-secondary-800 py-2.5 text-xs font-semibold text-secondary-800 transition-colors hover:bg-secondary-800 hover:text-white"
                >
                  View Details
